...
class ListaUsuariosView extends StatefulWidget {
  @override
  _ListaUsuariosView createState() => _ListaUsuariosView();

}


class _ListaUsuariosView  extends State<ListaUsuariosView> with TickerProviderStateMixin   {
      ...
      PopupMenuItem(
        child: new InkWell(
          ...
          child: new Row(
            ...
            children: <Widget>[
              IconButton(
                icon: Icon(Icons.person_outline ,size: 26 ,color: Color(0xFF000000)),
              ),
              Text('Perfil',
                  style: TextStyle(
                      fontSize: 17.0,
      ...
      PopupMenuItem(
        child: new InkWell(
          ...
          child: new Row(
            ...
            children: <Widget>[
              IconButton(
                icon: Icon(Icons.exit_to_app ,size: 26 ,color: Color(0xFF000000)),
              ),
              Text('Sair',
                  style: TextStyle(
                      fontSize: 17.0,
            ...
            children: <Widget>[
              ...
              FlatButton(
                  ...
                  onPressed: () async {
                    Navigator.of(context).pop();
                    try {
                      Navigator.of(context).pushAndRemoveUntil(new MaterialPageRoute(builder: (BuildContext context) => new LoginView()), (Route<dynamic> route) => false);
                    } catch (error) {
